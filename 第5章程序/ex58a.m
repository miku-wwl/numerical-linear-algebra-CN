...
x=zeros(size(A,2),1); ome=1.05; tol=1e-6; max_it=100; 
[x1,fval1,k1,time1]=kkt_sor(A,b,x,ome, tol,max_it);
[x,fval,k,time]=kkt_seidel(A,b,x,tol,max_it);
fprintf('\n'); fid = 1;
fprintf(fid, ' 算法   迭代次数    极小值     CPU时间   ' );     fprintf('\n');
fprintf(fid, ' KKTJ    %4i      %8.4f     %8.4f\n', k1, fval1, time1);   
