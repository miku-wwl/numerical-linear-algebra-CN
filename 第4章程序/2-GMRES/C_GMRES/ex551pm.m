...
max_it=1000;   M=diag(diag(A)); rm=norm(M\b);  restrt=10;
[x1, k1, j1  time1, res1, resvec1, flag1] = cpgmresm (A, b, x, M, restrt, max_it, tol);       %GMRES,
tic
[x2, flag2, res2, k2, resvec2] = gmres(A, b, restrt, tol, max_it, M);   %系统自带的GMRES函数
time2=toc;
%显示误差
