%QMRES·½·¨³ÌÐò-qmres.m
function [x,k,time,res,resvec]=pqmres(A,b,x,M,max_it, tol)
tic; r=M\(b-A*x);  bt=norm(r); v1=r/bt; 
w1=v1;  av=(M\A)*v1; atw=(M\A)'*w1; alpha=w1'*av;
...
while (k<max_it)
    av=(M\A)*v2; atw=(M\A)'*w2;  alpha=w2'*av; 
