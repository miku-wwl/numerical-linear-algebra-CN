%例3.7(2)-ex37_2.m
m=4000; t=3; n=m*t; tol=1.e-12; a=1;
...
[x,iter1,res1,time1]=PEa2(A,B,C,f,0.0,x0,tol);
[x,iter2,res2,time2]=PEa2(A,B,C,f,1.0,x0,tol);
[x,iter3,res3,time3]=PEa2(A,B,C,f,2.0,x0,tol);
[x,iter4,res4,time4]=PEa2(A,B,C,f,3.0,x0,tol);
[x,iter5,res5,time5]=PEa2(A,B,C,f,4.0,x0,tol);
[x,iter6,res6,time6]=PEa2(A,B,C,f,5.0,x0,tol);
...
fprintf(fid, '   a=3.0     %4i     %4.4f     %11.4e\n', iter4,time4,res4); fprintf('\n');
